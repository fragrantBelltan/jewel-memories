...
## v11 追加内容
表記を「石言葉占い｜Jewel Memories」に更新しました。

診断結果ページに note 深掘りリンクを追加しました。
表示順：
石言葉 → キャラ → メッセージ → この言葉をもっと読む → この言葉のグッズを見る

反映済みnoteリンク：
オニキス / 成功
https://note.com/fragrant_witch/n/ncf635f9f2bda

ダイヤモンド / 純潔
https://note.com/fragrant_witch/n/n4a9da13f74b2

note未作成キャラは「この言葉をもっと読む」ボタンを非表示にしています。
